...
const Reports = () => {
  return (
    <>
      <div className="bg-white bg-opacity-10 p-8 px-20 w-full">
        {/* Navbar */}
        <nav className=" bg-gradient-to-r from-blue-400 via-blue-500 to-blue-700 text-white shadow-md">
          <div className="container mx-auto px-4 py-4 flex justify-between items-center">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="text-blue-800">
                <h2 className="text-xl font-bold">ABC Patient</h2>
                <p className="text-lg">Age: 35 | Gender: Male</p>
            ...
            <div className="flex space-x-4">
              <motion.button
                className="bg-blue-800 text-white px-6 py-2 rounded-full text-lg font-semibold hover:bg-blue-700 transition shadow-md"
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
              >
                Book Appointment
              ...
              <motion.button
                className="bg-green-500 text-white px-6 py-2 rounded-full text-lg font-semibold hover:bg-red-600 transition shadow-md"
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
              >
                Logout
